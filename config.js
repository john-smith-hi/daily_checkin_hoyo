...
export const CONFIG = {
    ...
    HONKAI_STAR_RAIL_X_RPC_SIGNGAME: 'hkrpg',
    ...
    ZENDLESS_ZONE_ZERO_URL_API_CHECKIN: 'https://sg-public-api.hoyolab.com/event/luna/zzz/os/sign?lang=vi-vn',
    ZENDLESS_ZONE_ZERO_METHOD: 'POST',
    ZENDLESS_ZONE_ZERO_ACT_ID: 'e202406031448091',
    ZENDLESS_ZONE_ZERO_X_RPC_SIGNGAME: 'zzz',
    ZENDLESS_ZONE_ZERO_VARIABLE_NAME: 'retcode',
    ZENDLESS_ZONE_ZERO_VARIABLE_VALUE_SUCCESS: 0,
    ZENDLESS_ZONE_ZERO_VARIABLE_VALUE_CHECKED: -5003,
